...
class CRYSEDIT_CLASS_DECL CCrystalTextView : public CWnd
{
	DECLARE_DYNAMIC(CCrystalTextView)
//temporally loopbacks
	CSplitterWnd *GetParentSplitter( CWnd *, BOOL ){return 0;};
private:
	//	Search parameters
	BOOL m_bLastSearch;
