========================================================================
		ActiveX Control DLL : DBCONTROLS
========================================================================

ControlWizard has created this project for your DBCONTROLS ActiveX Control
...
that make up your DBCONTROLS ActiveX Control DLL.
...
DBControlsCtl.h
	This file contains the declaration of the CDBControlsCtrl C++ class.

DBControlsCtl.cpp
	This file contains the implementation of the CDBControlsCtrl C++ class.

DBControlsPpg.h
	This file contains the declaration of the CDBControlsPropPage C++ class.

DBControlsPpg.cpp
	This file contains the implementation of the CDBControlsPropPage C++ class.

DBControlsCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CDBControlsCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file DBControls.rc.
