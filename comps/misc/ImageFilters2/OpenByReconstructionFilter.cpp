// OpenByReconstructionFilter.cpp: implementation of the COpenByReconstructionFilter class.
//
//////////////////////////////////////////////////////////////////////
...
_ainfo_base::arg	COpenByReconstructionInfo::s_pargs[] = 
{	
...
bool COpenByReconstructionFilter::InvokeFilter()
{
	...
	return OpenByReconstruction(nMaskType,nMaskSize,nColorEpsilon,ptrSrcImage,ptrDestImage);
}