...
namespace ViewSpace 
{
	...
	class CCmpLegendWnd : public win_impl
	{
...
//		COLORREF m_clTextColorTitle;
	...
	public:
		...
		void attach_data();
		void _add_attach_data( IUnknownPtr sptrData );
...
private:
	bool m_bPrinting;
	int m_NStr;
	// Уровень вероятности гипотезы равенства дисперсий
	double m_fFisherProbability;
public:
	void SetHighlight(unsigned iStat);
private:
	unsigned m_iHighlightedStat;
	::Gdiplus::Color m_ColorHighlighted;
};
}