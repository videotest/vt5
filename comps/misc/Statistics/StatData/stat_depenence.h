...
{
/********************************************************************/
class stat_depenence_view : public CWinViewBase, 
				public IPrintView,
				public IPersist,
				public CNamedObjectImpl,
				public CHelpInfoImpl,
				public CNamedPropBagImpl,
				public _dyncreate_t<stat_depenence_view>
{
...
protected:
		...
		void _menage_grid( long lid, double fmin_value_x, double fmax_value_x, double fmin_value_y, double fmax_value_y, double fcoef_x, double fcoef_y );
};
/********************************************************************/
};
