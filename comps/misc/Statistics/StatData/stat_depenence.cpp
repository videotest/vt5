...
//////////////////////////////////////////////////////////////////////
stat_depenence_view::stat_depenence_view(void)
{
...
//////////////////////////////////////////////////////////////////////
stat_depenence_view::~stat_depenence_view()
{
	_deinit();
}
//////////////////////////////////////////////////////////////////////
void stat_depenence_view::_init()
{
	NULLING( m_rc_title			);
	NULLING( m_rc_xparam		);
	NULLING( m_rc_yparam		);
...
//////////////////////////////////////////////////////////////////////
void stat_depenence_view::_deinit()
{
}
//////////////////////////////////////////////////////////////////////
IUnknown* stat_depenence_view::DoGetInterface( const IID &iid )
{
...
//////////////////////////////////////////////////////////////////////
void stat_depenence_view::DoAttachObjects()
{
...
//////////////////////////////////////////////////////////////////////
LRESULT	stat_depenence_view::DoMessage( UINT nMsg, WPARAM wParam, LPARAM lParam )
{
	LRESULT	lResult = 0;
	switch( nMsg )
	{
...
//////////////////////////////////////////////////////////////////////
long stat_depenence_view::on_create( CREATESTRUCT *pcs )
{
	RECT rect = { 0,   0  , 1, 1 };
...
//////////////////////////////////////////////////////////////////////
long stat_depenence_view::on_destroy()
{
	for( long lpos_lst = m_list_attached.head(); lpos_lst; lpos_lst = m_list_attached.next( lpos_lst ) )
	{
		IUnknownPtr ptr_object = m_list_attached.get( lpos_lst );
...
//////////////////////////////////////////////////////////////////////
long stat_depenence_view::on_paint()
{
...
//////////////////////////////////////////////////////////////////////
long stat_depenence_view::on_erase_background( HDC hDC )
{
	return 1L;
}

//////////////////////////////////////////////////////////////////////
long stat_depenence_view::on_size( int cx, int cy )
{
...
//////////////////////////////////////////////////////////////////////
long stat_depenence_view::on_context_menu( HWND hWnd, int x, int y )
{
	POINT pt;
	pt.x = x;
	pt.y = y;
...
//////////////////////////////////////////////////////////////////////
HRESULT stat_depenence_view::GetMatchType( BSTR bstrObjectType, DWORD *pdwMatch )
{
...
//////////////////////////////////////////////////////////////////////
void stat_depenence_view::OnNotify( const char *pszEvent, IUnknown *punkHit, IUnknown *punkFrom, void *pdata, long cbSize )
{
...
//////////////////////////////////////////////////////////////////////
HRESULT stat_depenence_view::GetPrintWidth( int nMaxWidth, int *pnReturnWidth, BOOL *pbContinue, int nUserPosX, int *pnNewUserPosX )
{
...
//////////////////////////////////////////////////////////////////////
HRESULT stat_depenence_view::GetPrintHeight( int nMaxHeight, int *pnReturnHeight, BOOL *pbContinue, int nUserPosY, int *pnNewUserPosY )
{
//	m_wnd_data.block_recalc = true;
	bool bcontinue = false;
...
//////////////////////////////////////////////////////////////////////
HRESULT stat_depenence_view::Print( HDC hdc, RECT rectTarget, int nUserPosX, int nUserPosY, int nUserPosDX, int nUserPosDY, BOOL bUseScrollZoom, DWORD dwFlags )
{
	IScrollZoomSitePtr ptr_zoom = Unknown();
	double fzoom_view = 1;
...
//////////////////////////////////////////////////////////////////////
HRESULT stat_depenence_view::GetClassID(CLSID *pClassID )
{
	if( !pClassID )	
		return E_POINTER;
...
//////////////////////////////////////////////////////////////////////
HRESULT stat_depenence_view::GetFirstVisibleObjectPosition( long *plpos )
{
	if( !plpos )
		return S_FALSE;
...
//////////////////////////////////////////////////////////////////////
HRESULT stat_depenence_view::GetNextVisibleObject( IUnknown ** ppunkObject, long *plPos )
{
	if( !plPos )
		return S_FALSE;
...
//////////////////////////////////////////////////////////////////////
bool stat_depenence_view::_is_ndata_empty( IUnknownPtr sptr )
{
...
//////////////////////////////////////////////////////////////////////
void stat_depenence_view::_set_modify()
{
	for( long lpos_lst = m_list_attached.head(); lpos_lst; lpos_lst = m_list_attached.next( lpos_lst ) )
	{
		IUnknownPtr ptr_object = m_list_attached.get( lpos_lst );
...
//////////////////////////////////////////////////////////////////////
void stat_depenence_view::_attach_data()
{
	m_lst_legend.clear();
	m_wnd_layout.m_lst_legend_layout.clear();
	...
	for( long lpos = m_list_attached.head(), lid = 0; lpos; lpos = m_list_attached.next( lpos ), lid++  )
	{
		...
		if( m_chart_params.ndependance_type == 1 )
			fcoef_correl = _get_correl( sptr_table, nmodel, &fa, &fb, &pbbdepend_error[lid] );
		else if( m_chart_params.ndependance_type == 2 )
		{
			if( !lid )
			{
		...
		{
			if( m_chart_params.ndependance_type )
			...
			if( pvalue_x && pvalue_x->bwas_defined && pvalue_y && pvalue_y->bwas_defined)
			{
				for( long lp_lst = m_chart_params.m_lst_marker.head(), id = 0; lp_lst; lp_lst = m_chart_params.m_lst_marker.next( lp_lst ), id++ )
				{
					if( id == lid )
					{
						...
						if( m_chart_params.buse_loga_scale_x )
						{
							double _min_x = f_abs_min_value_x;
							x = ( log10( pvalue_x->fvalue ) - log10( _min_x ) ) / ( log10( f_abs_max_value_x ) - log10( _min_x ) );
						}

						if( m_chart_params.buse_loga_scale_y )
						{
							double _min_y = f_abs_min_value_y;
							y = ( log10( pvalue_y->fvalue ) - log10( _min_y ) ) / ( log10( f_abs_max_value_y ) - log10( _min_y ) );
						}
	...
	if( !m_wnd_data.berror )
	{
   	if( m_chart_params.ndependance_type && !berror )
	{
		for( long lpos = m_list_attached.head(), lid = 0; lpos; lpos = m_list_attached.next( lpos ), lid++  )
		{
			if( !m_chart_params.buse_loga_scale_x )
	...
	for( lid = -1; lid < m_list_attached.count(); lid++  )
	{
		...
		if( m_chart_params.bx_grid || m_chart_params.by_grid )
			_menage_grid( lid, f_abs_min_value_x, f_abs_max_value_x, f_abs_min_value_y, f_abs_max_value_y, 1, 1 );
	}
	}
...
//////////////////////////////////////////////////////////////////////
void stat_depenence_view::_recalc_layout()
{
...
//////////////////////////////////////////////////////////////////////
void stat_depenence_view::_calc_min_rect( bool bprint_mode )
{
...
//////////////////////////////////////////////////////////////////////
void stat_depenence_view::_do_draw( HDC hdc, RECT rc_paint, bool bcalc, double fzoom, bool bprint  )
{
...
//////////////////////////////////////////////////////////////////////
void stat_depenence_view::_load_from_ndata(  INamedDataPtr sptr_nd )
{
	...
	m_chart_params.m_buse_custom_format_x = ::GetValueInt( sptr_nd, SECT_DEPENDENCE_CHART_AXIS_ROOT, X_USE_CUSTOM_FORMAT, m_chart_params.m_buse_custom_format_x ) != 0;
	...
	m_chart_params.ndependance_type = ::GetValueInt( sptr_nd, SECT_DEPENDENCE_ROOT, DEPENDENCE_TYPE, m_chart_params.ndependance_type );
...
//////////////////////////////////////////////////////////////////////
void stat_depenence_view::_store_to_ndata( INamedDataPtr sptr_nd )
{
	...
	::SetValue( sptr_nd, SECT_DEPENDENCE_ROOT, DEPENDENCE_TYPE, (long)m_chart_params.ndependance_type );
...
//////////////////////////////////////////////////////////////////////
CString stat_depenence_view::_get_f_str( int nmodel, double fa, double fb )
{
	CString ret;
...
//////////////////////////////////////////////////////////////////////
double stat_depenence_view::_get_f( int nmodel, double a, double b, double x )
{
	switch( nmodel )
	{
		case 0: return ( a + b*x );
		...
		case 4: return ( a * exp( b * x ) );
		case 5: return ( a * pow( 10, b * x ) );
		case 6: return ( a * pow( x, b ) );
		case 7: return ( a  +  b * log10( x ) );
		case 8: return ( a  +  b * log( x ) );
		case 9: return ( a * exp( b / x ) );
		case 10: return ( a * pow( 10, b / x ) );
		case 11: return ( a + b * x * x );
		case 12: return (a + b * x * x * x );
	}
	return 0;
}

//////////////////////////////////////////////////////////////////////
double stat_depenence_view::_get_correl( IStatTable *punk_table, long lmodel, double *pa, double *pb, bool *pberrr )
{
	double fsum_x = 0;
	double fsum_y = 0;
	double fsum_xx = 0;
...
//////////////////////////////////////////////////////////////////////
void stat_depenence_view::_manage_labels( long lid, double fmin_value_x, double fmax_value_x, double fmin_value_y, double fmax_value_y, double fcoef_x, double fcoef_y )
{
	IChartAttributesPtr ptr_chart_atrr = m_sptr_chart;
...
//////////////////////////////////////////////////////////////////////
void stat_depenence_view::_manage_values(long lid, double fmin_value_x, double fmax_value_x, double fmin_value_y, double fmax_value_y
...
//////////////////////////////////////////////////////////////////////
void stat_depenence_view::_menage_grid(  long lid, double fmin_value_x, double fmax_value_x, double fmin_value_y, double fmax_value_y, double fcoef_x, double fcoef_y )
{
	IChartAttributesPtr ptr_chart_atrr = m_sptr_chart;
