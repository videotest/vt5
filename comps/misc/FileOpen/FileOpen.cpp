// FileOpen.cpp : Defines the initialization routines for the DLL.
//
...
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	AfxOleRegisterTypeLib(AfxGetInstanceHandle(), IID_ITypeLibID, _T("FileOpen.tlb") );
	CCompRegistrator	rs( szPluginScriptNamespace );
	rs.RegisterComponent( "FileOpen.FileOpenDlg" );
...
STDAPI DllUnregisterServer(void)
{
	...
	CCompRegistrator	rs( szPluginScriptNamespace );
	rs.UnRegisterComponent( "FileOpen.FileOpenDlg" );
