...
float mahalanobis(fv, mv, vcv, dim)
int dim;
double *fv, *mv;
register double *vcv;
 ...
 */
classmahal (fvec,priorp,liklv,nclass,ndim)
double *fvec, *priorp;
struct cllik *liklv;
{
	int i,maxc, liksort();
 ...
 */
classdist (fvec,lpriorp,liklv,nclass,ndim)
double *fvec, *lpriorp;
...
iclassdist (fvec,priorp,liklv,nclass,ndim)
int *fvec;
double *priorp;
struct cllik *liklv;
{
