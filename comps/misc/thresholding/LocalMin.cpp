// LocalMax.cpp: implementation of the COpenByReconstructionFilter class.
//
//////////////////////////////////////////////////////////////////////
...
_ainfo_base::arg	CLocalMaxInfo::s_pargs[] = 
{
	{"Img",		szArgumentTypeImage, 0, true, true },
	{"LocalMax",szArgumentTypeBinaryImage, 0, false, true },
	{0, 0, 0, false, false },
};

bool CLocalMaxFilter::InvokeFilter()
{
...
bool CLocalMaxFilter::CanDeleteArgument( CFilterArgument *pa )
{
	return false;
}
