...
public:
	...
	com_call GetValuesCount(int nCurDev, int *pnValues) {return E_NOTIMPLEMENTED;}
	com_call GetValueInfo(int nCurDev, int nValue, VALUEINFOEX *pValueInfo) {return E_NOTIMPLEMENTED;}
