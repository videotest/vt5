...
//#define sStringer( x ) char [] #x x
//#if defined(_UNICODE)
//#error _UNICODE true
//#else
//#error _UNICODE false
//#endif
...
template<typename TMethodOrig, typename TMethodHook>
...
public:
  ...
  CAPIHookMethod(PSTR pszCalleeModName, PSTR pszFuncName, TMethodOrig pfnOrig, TMethodHook pfnHook, 
...
template<typename TMethodOrig, typename TMethodHook>
CAPIHookMethod<TMethodOrig, TMethodHook>::CAPIHookMethod(PSTR pszCalleeModName, PSTR pszFuncName 
		, TMethodOrig pfnOrig, TMethodHook pfnHook, BOOL fExcludeAPIHookMod)
 {
...
template<typename TMethodOrig, typename TMethodHook>
CAPIHookMethod<TMethodOrig, TMethodHook>::~CAPIHookMethod() {
...
typedef LPUNKNOWN (CCmdTarget::*TGetInterfaceOrig)(const void* iid);
typedef LPUNKNOWN (__CCmdTarget__::*TGetInterfaceHook)(const void* iid);
CAPIHookMethod<TGetInterfaceOrig,TGetInterfaceHook> 
	g_GetInterface(MFCXXD_DLL, (PSTR)GetInterface_CCmdTarget_Ordinal, 
	&CCmdTarget::GetInterface, &__CCmdTarget__::__GetInterface__, 1);
...
typedef void (COleDispatchDriver::*PFN_ODD_Orig)(DISPID dwDispID, WORD wFlags, VARTYPE vtRet, void*pvRet, const BYTE*pbParamInfo, va_list argList); 
typedef void (__COleDispatchDriver__::*PFN_ODD_Hook)(DISPID dwDispID, WORD wFlags, VARTYPE vtRet, void*pvRet, const BYTE*pbParamInfo, va_list argList); 
