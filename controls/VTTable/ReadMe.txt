========================================================================
    ACTIVEX CONTROL DLL : VTTable Project Overview
========================================================================

ControlWizard has created this project for your VTTable ActiveX Control
...
that make up your VTTable ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
CVTTableCtrl control:

VTTableCtrl.h
    This file contains the declaration of the CVTTableCtrl C++ class.

VTTableCtrl.cpp
    This file contains the implementation of the CVTTableCtrl C++ class.

VTTablePropPage.h
    This file contains the declaration of the CVTTablePropPage C++ class.

VTTablePropPage.cpp
    This file contains the implementation of the CVTTablePropPage C++ class.

CVTTableCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CVTTableCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file VTTable.rc.
...
stdafx.h, stdafx.cpp
    ...
    named VTTable.pch and a precompiled types (PCT) file named stdafx.obj.
