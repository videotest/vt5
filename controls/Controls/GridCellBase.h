...
#define SELECTED_CELL_FONT_WEIGHT 400    // weight of text for selected items
...
control_export_class CGridCellBase : public CObject
{
...
protected:
    ...
    virtual void OnMouseEnter(int nRow, int nCol, CPoint pt);
    virtual void OnMouseOver(int nRow, int nCol, CPoint pt);
    virtual void OnMouseLeave(int nRow, int nCol, CPoint pt);
