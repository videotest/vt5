...
control_export_class CGridCell : public CGridCellBase
{
...
control_export_class CAdditionGridCell : public CGridCell
{
    friend class CGridCtrl;
    DECLARE_DYNCREATE(CAdditionGridCell)

// Construction/Destruction
public:
    CAdditionGridCell();
    virtual ~CAdditionGridCell();
