========================================================================
		ActiveX Control DLL : PRINTFIELDAX
========================================================================

ControlWizard has created this project for your PRINTFIELDAX ActiveX Control
...
that make up your PRINTFIELDAX ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
PrintFieldAX control:

PrintFieldAXCtl.h
	This file contains the declaration of the CPrintFieldAXCtrl C++ class.

PrintFieldAXCtl.cpp
	This file contains the implementation of the CPrintFieldAXCtrl C++ class.

PrintFieldAXPpg.h
	This file contains the declaration of the CPrintFieldAXPropPage C++ class.

PrintFieldAXPpg.cpp
	This file contains the implementation of the CPrintFieldAXPropPage C++ class.

PrintFieldAXCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CPrintFieldAXCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file PrintFieldAX.rc.
