...
========================================================================
		ActiveX Control DLL : ACIVECOLORSVIEW
========================================================================

ControlWizard has created this project for your ACIVECOLORSVIEW ActiveX Control
...
that make up your ACIVECOLORSVIEW ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
AciveColorsView control:

AciveColorsViewCtl.h
	This file contains the declaration of the CAciveColorsViewCtrl C++ class.

AciveColorsViewCtl.cpp
	This file contains the implementation of the CAciveColorsViewCtrl C++ class.

AciveColorsViewPpg.h
	This file contains the declaration of the CAciveColorsViewPropPage C++ class.

AciveColorsViewPpg.cpp
	This file contains the implementation of the CAciveColorsViewPropPage C++ class.

AciveColorsViewCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CAciveColorsViewCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file AciveColorsView.rc.
