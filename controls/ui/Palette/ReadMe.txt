========================================================================
		ActiveX Control DLL : PALETTE
========================================================================

ControlWizard has created this project for your PALETTE ActiveX Control
...
that make up your PALETTE ActiveX Control DLL.
...
PaletteCtl.h
	This file contains the declaration of the CPaletteCtrl C++ class.

PaletteCtl.cpp
	This file contains the implementation of the CPaletteCtrl C++ class.

PalettePpg.h
	This file contains the declaration of the CPalettePropPage C++ class.

PalettePpg.cpp
	This file contains the implementation of the CPalettePropPage C++ class.

PaletteCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CPaletteCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file Palette.rc.
