========================================================================
		ActiveX Control DLL : COLORMANAX
========================================================================

ControlWizard has created this project for your COLORMANAX ActiveX Control
...
that make up your COLORMANAX ActiveX Control DLL.
...
ColorManAXCtl.h
	This file contains the declaration of the CColorManAXCtrl C++ class.

ColorManAXCtl.cpp
	This file contains the implementation of the CColorManAXCtrl C++ class.

ColorManAXPpg.h
	This file contains the declaration of the CColorManAXPropPage C++ class.

ColorManAXPpg.cpp
	This file contains the implementation of the CColorManAXPropPage C++ class.

ColorManAXCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CColorManAXCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file ColorManAX.rc.
