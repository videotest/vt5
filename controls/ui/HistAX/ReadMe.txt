========================================================================
		ActiveX Control DLL : HISTAX
========================================================================

ControlWizard has created this project for your HISTAX ActiveX Control
...
that make up your HISTAX ActiveX Control DLL.
...
HistAXCtl.h
	This file contains the declaration of the CHistAXCtrl C++ class.

HistAXCtl.cpp
	This file contains the implementation of the CHistAXCtrl C++ class.

HistAXPpg.h
	This file contains the declaration of the CHistAXPropPage C++ class.

HistAXPpg.cpp
	This file contains the implementation of the CHistAXPropPage C++ class.

HistAXCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CHistAXCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file HistAX.rc.
