========================================================================
		ActiveX Control DLL : VIEWAX
========================================================================

ControlWizard has created this project for your VIEWAX ActiveX Control
...
that make up your VIEWAX ActiveX Control DLL.
...
ViewAXCtl.h
	This file contains the declaration of the CViewAXCtrl C++ class.

ViewAXCtl.cpp
	This file contains the implementation of the CViewAXCtrl C++ class.

ViewAXPpg.h
	This file contains the declaration of the CViewAXPropPage C++ class.

ViewAXPpg.cpp
	This file contains the implementation of the CViewAXPropPage C++ class.

ViewAXCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CViewAXCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file ViewAX.rc.
